...
import com.dirusso_vanderouw.waves.presenter.FragmentBeachPresenter;
import com.dirusso_vanderouw.waves.presenter.MapFragmentPresenter;
import com.dirusso_vanderouw.waves.view.BeachListView;
...
import dirusso_vanderouw.services.models.LatitudeLongitude;
...
public class MapFragmentPresenterTest {
    ...
    public void setUp() {
        ...
        presenter = new MapFragmentPresenter(wavesRepository);
    ...
    @Test
    public void getValueIdForAttributeNull() {
        Assert.assertNull(presenter.getValueIdForAttribute("NON EXISTENT", 90));
    }

    @Test
    public void getValueIdForAttributeOK() {
        String type = "WAVES";
        int value = 2;
        Attribute attribute = presenter.getValueIdForAttribute(type, value);
        Assert.assertNotNull(attribute);
        Assert.assertEquals(type, Attribute.WAVES_HIGH.getType());
        Assert.assertTrue(value == Attribute.WAVES_HIGH.getValue());
        Assert.assertEquals(attribute, Attribute.WAVES_HIGH);
    }
