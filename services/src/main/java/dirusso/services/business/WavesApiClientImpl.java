...
public class WavesApiClientImpl implements WavesRepository {
    ...
    public Observable<List<Beach>> getBeaches() {
        ...
        Beach beach2 = new Beach.Builder(upLeft, upRight, downLeft, downRight).withId(2)
                                                                              ...
                                                                              .withAttributes(Lists.newArrayList(new AttributeValue("FLAG", 1), new
        ...
        Beach beach6 = new Beach.Builder(upLeft, upRight, downLeft, downRight).withId(3)
    ...
    public Observable<List<Beach>> reportDataFromBeach(String beachId, Beach beach) {
        int beachIndex = beaches.indexOf(beach);
        beaches.remove(beaches.indexOf(beach));
